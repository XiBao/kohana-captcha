...
abstract class Captcha
{
	...
	public function image_render($html)
	{
		// Output html element
		if ($html === TRUE)
			//return '<img src="'.Subdomain_URL::site('captcha', 'sem').'" width="'.Captcha::$config['width'].'" height="'.Captcha::$config['height'].'" alt="Captcha" class="captcha" />';
			return '<img src="/captcha" width="'.Captcha::$config['width'].'" height="'.Captcha::$config['height'].'" alt="Captcha" class="captcha" />';
